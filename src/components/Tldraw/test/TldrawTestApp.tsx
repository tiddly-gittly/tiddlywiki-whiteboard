...
import type { TDShape } from '@tldr/types';
...
export class TldrawTestApp extends TldrawApp {
  ...
  pointCanvas = (options?: PointerOptions | number[]) => {
    this.onPointCanvas(inputs.pointerDown(this.getPoint(options), 'canvas'), {} as React.PointerEvent);
    this.onPointerDown(inputs.pointerDown(this.getPoint(options), 'canvas'), {} as React.PointerEvent);
    return this;
  };
  ...
  doubleClickCanvas = (options?: PointerOptions | number[]) => {
    this.onPointerDown(inputs.pointerDown(this.getPoint(options), 'canvas'), {} as React.PointerEvent);
    this.onDoubleClickCanvas(inputs.pointerDown(this.getPoint(options), 'canvas'), {} as React.PointerEvent);
  ...
  doubleClickShape = (id: string, options?: PointerOptions | number[]) => {
    this.onPointerDown(inputs.pointerDown(this.getPoint(options), 'canvas'), {} as React.PointerEvent);
    this.onDoubleClickShape(inputs.pointerDown(this.getPoint(options), id), {} as React.PointerEvent);
    this.onPointerUp(inputs.pointerUp(this.getPoint(options), 'canvas'), {} as React.PointerEvent);
    return this;
  };

  pointBounds = (options?: PointerOptions | number[]) => {
    this.onPointBounds(inputs.pointerDown(this.getPoint(options), 'bounds'), {} as React.PointerEvent);
    this.onPointerDown(inputs.pointerDown(this.getPoint(options), 'canvas'), {} as React.PointerEvent);
    return this;
  };

  pointBoundsHandle = (id: TLBoundsHandle, options?: PointerOptions | number[]) => {
    this.onPointBoundsHandle(inputs.pointerDown(this.getPoint(options), id), {} as React.PointerEvent);
  ...
  doubleClickBoundHandle = (id: TLBoundsHandle, options?: PointerOptions | number[]) => {
    ...
    this.onPointerDown(inputs.pointerDown(this.getPoint(options), id), {} as React.PointerEvent);
    this.onDoubleClickBoundsHandle(inputs.pointerUp(this.getPoint(options), id), {} as React.PointerEvent);
    this.onReleaseBoundsHandle?.(inputs.pointerDown(this.getPoint(options), id), {} as React.PointerEvent);
    this.onPointerUp?.(inputs.pointerUp(this.getPoint(options), id), {} as React.PointerEvent);
    return this;
  };
  ...
  clickBoundsHandle = (id: TLBoundsCorner | TLBoundsEdge | 'rotate', options: PointerOptions = {}) => {
  ...
  getPoint(options: PointerOptions | number[] = {} as PointerOptions): PointerEvent {
    const options_ = Array.isArray(options) ? { x: options[0], y: options[1], pressure: options[2] } : options;
    const { id = 1, x = 0, y = 0, pressure = 0.5, shiftKey = false, altKey = false, ctrlKey = false } = options_;
