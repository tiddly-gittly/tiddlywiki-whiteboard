...
import { ColorStyle, DashStyle, SessionType, SizeStyle, TDAssetType, TDDocument, TDShapeType } from '@tldr/types';
...
describe('Delete command', () => {
  ...
  describe('when deleting grouped shapes', () => {
    it('deletes the group too', () => {
      const app = new TldrawTestApp().loadDocument(mockDocument).group(['rect1', 'rect2', 'rect3'], 'newGroup').select('rect1', 'rect2', 'rect3').delete();
