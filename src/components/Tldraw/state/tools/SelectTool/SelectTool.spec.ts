...
describe('When double clicking link controls', () => {
  ...
  it('moves all upstream shapes when center is dragged', () => {
    const app = new TldrawTestApp().loadDocument(doc).select('rect2').pointBoundsHandle('center').movePointer({ x: 100, y: 100 });
  ...
  it('moves all downstream shapes when center is dragged', () => {
    const app = new TldrawTestApp().loadDocument(doc).select('rect2').pointBoundsHandle('right').movePointer({ x: 100, y: 100 });
  ...
  it('selects all linked shapes when center is double clicked', () => {
    new TldrawTestApp().loadDocument(doc).select('rect2').doubleClickBoundHandle('center').expectSelectedIdsToBe(['rect2', 'rect1', 'rect3']);
  });
  ...
  it('selects all upstream linked shapes when left is double clicked', () => {
    new TldrawTestApp().loadDocument(doc).select('rect2').doubleClickBoundHandle('left').expectSelectedIdsToBe(['rect1', 'rect2']);
  });
  ...
  it('selects all downstream linked shapes when right is double clicked', () => {
    new TldrawTestApp().loadDocument(doc).select('rect2').doubleClickBoundHandle('right').expectSelectedIdsToBe(['rect2', 'rect3']);
  });
